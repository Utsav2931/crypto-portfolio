						...
						if(!empty(coins)) {
							...
							parseHoldings(coins).then(holdings => {
								...
								Object.keys(holdings).map(holding => {
									...
									data.push({x : symbol, value: amount})
									console.log("Pushing");
								...
								chart.title("Holdings pie chart");
								chart.data(data);
								var divElement = document.createElement("div");
								divElement.classList.add("chart-container");
								divElement.id = "chart-container";
								divHoldingsList.appendChild(divElement);
